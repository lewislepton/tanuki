...
import tanuki.tween.Tween.TweenAction;
import tanuki.tween.Ease.Linear;
import tanuki.tween.tweens.FloatTween;
import tanuki.tween.tweens.IndexTween;
import tanuki.tween.tweens.FuncTween;
