...
import kha.Blob;
import tanuki.tmx.Data.TmxMap;
import tanuki.tmx.Reader;
import tanuki.tmx.Data.TmxObject;
import tanuki.tmx.Data.TmxObjectType;
import tanuki.tmx.Tools;
...
{	
	...
	public function new(tmxFile:Blob, fixObjectPos:Bool = false):Void
	{
		...
		tmxMap = reader.read(Xml.parse(tmxFile.toString()));
